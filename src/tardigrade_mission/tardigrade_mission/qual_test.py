...
class QualTest(Node):
    """Run the qual path through the active ESP depth-control command path."""

    def __init__(self):
        super().__init__('qual_test')
    ...
    def run(self):
        ...
        self.get_logger().warn(
            f'QUAL WILL MOVE in {self.startup_delay_sec:.1f} seconds; '
        ...
        try:
            ...
            self.get_logger().info('Qual path complete')
        finally:
            self.publish_zero()
